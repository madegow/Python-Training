...
jeevika:x:1001:1001::/home/jeevika:/bin/bash
keerthana:x:1002:1002::/home/keerthana:/bin/bash"""
...
for index in range(len(lines)):
    ...
    if line.endswith('/bin/bash'):
        print(f"user : {line.split(':')[0]} has bash login")
    if(int(line.split(":")[2]) >= 1000):
        print(f"{line.split(':')[0]} has userid more than 1000")
